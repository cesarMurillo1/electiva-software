...
roles={
    ('Coordinador de trabajo de grado','Coordinador de trabajo de grado'),
    ('Coordinador de práctica','Coordinador de práctica'),
    ('Jurado','Jurado'),
    ('Director de trabajo de grado','Director de trabajo de grado'),
   ('Asesor de trabajo de grado','Asesor de trabajo de grado'),
   ('Profesor','Profesor')
}
etiquetas={
    ('Aprobada','Aprobada'),
...
class usuario(AbstractUser): 
    ...
    rol=models.CharField(null=False,blank=False,choices=roles,default=1,max_length=100)
    def __str__(self):
...
class enviar(models.Model): 
    ...
    etiqueta = models.CharField(null=False,blank=False,choices=etiquetas,default=1,max_length=100)
    class Meta:
        verbose_name = 'enviar'
